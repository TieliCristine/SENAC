...
public class Gerente extends Funcionario {
    ...
    public Gerente(String nome, double salario, Endereco ruaLegal) {
        super(nome, salario, ruaLegal);
    }

    public Gerente(String nome, double salario, String setor, Endereco ruaLegal) {
        super(nome, salario,ruaLegal);
        this.setor = setor;
    }
